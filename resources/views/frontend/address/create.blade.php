                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-20">
                            ...
                            <input type="text" name="shipping_name" class="form-control" value="{{ old('shipping_name') }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-20">
                            <label for="shipping_email">Email</label>
                            <input type="email" name="shipping_email" class="form-control" value="{{ old('shipping_email') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-20">
                            ...
                            <select name="city_id" id="city_id" disabled class="form-control">
