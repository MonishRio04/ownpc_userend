...
<div class="container">
    <div class="row">
            ...
            <div class="table-responsive">
                <table class="table" style="font-weight:600;">
                    <tbody>
                        ...
                        <tr>
                            <td class="col-md-1">
                                <label><img src="{{asset($item->product->product_thambnail)}}" style="width:50px;height:50px;" alt=""></label>
                            </td>
                            <td class="col-md-2">
        ...
        <div class="form-group" style="font-weight: 600; font-size:initial; color:#000000;">
            ...
            <textarea name="return_reason" class="form-control mb-2" style="width:40%;"></textarea>
            <button type="submit" class="btn-sm btn-danger" style="width:40%;">Order Return</button>
            </form>
            @else
            <h5><span class="" style="color:red;">You have sent return for this request</span></h5> <br><br>
            @endif
        </div>
        @endif
