        ...
        <div class="container pt-15 pb-20">
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            ...
                            <p class="font-lg text-heading">Bringing joy to your little ones</p>
                        </div>
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-clock.svg')}}" alt="" /><strong>Hours:</strong><span>9:30 AM - 9:30 PM IST, Mon - Sat</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                    ...
                    <?php $products = \App\Models\Product::latest()->limit(5)->get();?>
                    <ul class="footer-list mb-sm-5 mb-md-0">
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">&copy;<strong class="text-brand"></strong>{{$setting->copyright}}</p>
            </div>
