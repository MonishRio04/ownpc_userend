                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            <h5 class="title-detail"><a href="" id="pname" class="text-heading"></a></h5><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="font-xs">
                                        <ul>
                                            <li class="mb-5">Product Code: <span class="text-brand" id="pcode" style="background:green;color:white;"></span></li>
