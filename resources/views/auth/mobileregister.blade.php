                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Already have an account? <a href="{{ route('mobilelogin') }}">Login</a></p>
                                        </div>
                                        <form method="POST" action="{{ route('mobileregisterOTPvalidation') }}">
                                            @csrf
                                            <div class="form-group">
                                                <input type="text" id="name" required="" name="name" placeholder="Username" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" id="phone" required="" name="phone" placeholder="Mobile Number" />
                                            </div>
                                            <div class="form-group">
