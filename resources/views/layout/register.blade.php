    ...
    <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-8 relative dark:bg-gray-900">
        ...
        <form>
            <input type="text" placeholder="Your Name"
                class="w-full mb-4 px-4 py-2 bg-gray-200 rounded dark:bg-gray-800 dark:text-white">
            ...
            <button type="submit"
                class="w-full bg-orange-400 hover:bg-[#0B1D51] text-white font-semibold py-2 rounded">
                Register
            </button>
        </form>
        ...
        <div class="flex justify-center space-x-4 mt-4">
            ...
            <button
                class="bg-sky-400 hover:bg-sky-500 text-white w-10 h-10 rounded-full flex items-center justify-center">
