...
<div class="bg-white text-center sm:text-left text-gray-600 text-xs sm:text-sm py-2 dark:bg-gray-800 dark:text-gray-400">
    <div class="container mx-auto px-10 flex flex-col sm:flex-row justify-between items-center gap-2">
        ...
        <div class="flex items-center space-x-3">
            <div class="flex items-center gap-1 cursor-pointer hover:text-orange-500" id="locationDropdown">
               <button id="locationToggle" type="button" class="group hover:text-orange-500 flex items-center gap-1">
                    <i class="fa-solid fa-location-pin text-gray-500 group-hover:text-orange-500 text-sm"></i>
                    Select Location
                </button>
            </div>
           
            @auth
                <span class=" sm:flex items-center space-x-2 font-medium text-gray-500 dark:text-white">
...
<hr>
<!-- Logo + Search + Icons -->
<div class="container mx-auto py-8 px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
    <a href="/" class="text-3xl font-bold flex items-center gap-1">
        <span class="text-orange-400">O</span><span class="text-gray-900 dark:text-white">wn</span>
        <span class="text-orange-400">P</span><span class="text-gray-900 dark:text-white">c</span>
    </a>
...
@auth
    ...
    <div class="relative block sm:hidden" id="mobileUserWrapper">
        ...
        <div id="mobileUserDropdown" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 text-black dark:text-white border border-gray-200 dark:border-gray-700 rounded-md shadow-lg hidden z-[999]">
...
@else
    <a href="{{ route('user.wishlist', Auth::user()?->id) }}" class="block px-4 py-2 hover:text-orange-500 dark:hover:text-orange-500">
        <i class="fa-solid fa-heart mr-2"></i> Wishlist
    </a>
@endauth
