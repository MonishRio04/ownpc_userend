...
<div class="relative w-full h-[400px] bg-white dark:bg-gray-900 overflow-hidden flex items-center justify-between px-16">
    <div class="z-10 max-w-xl text-black dark:text-white space-y-4 transform -translate-y-16">
        <p class="text-lg">
            The Home <span class="text-4xl font-bold">Appliances</span> Store
        </p>
        <p>
            <a href="/" class="text-orange-400 font-bold">HOME</a>
            <span class="mx-2 text-gray-500 dark:text-gray-300"><i class="fa-solid fa-greater-than text-xs"></i></span>
...
<div class="container mx-auto px-16 py-10">
    ...
    <ul class="space-y-1 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <div class="animate-scroll space-y-4">
                        @foreach(['Gaming Mouse' => '₹799', 'Mechanical Keyboard' => '₹2,499', 'RGB Cabinet' => '₹4,999'] as $name => $price)
                            <div class="flex items-center gap-3">
                                <img src="{{ asset('images/pc.png') }}" alt="Product" class="w-14 h-14 object-contain">
                                <div>
                                    <p class="text-sm font-medium text-gray-800 dark:text-gray-100 leading-tight">{{ $name }}</p>
        ...
        </div><div class="md:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    @for($i = 1; $i <= 6; $i++)
        <div class="bg-white dark:bg-gray-900 rounded shadow p-4 text-center hover:shadow-lg transition group">
            ...
            <div class="relative">
                ...
                <button class="absolute left-1/2 -translate-x-1/2 top-1/2 opacity-0 group-hover:opacity-100 translate-y-[-20px] group-hover:translate-y-2 transition-all bg-[#0B1D51] text-white px-4 py-1 text-sm rounded shadow">
                    Quick View
                </button>
            </div>
            ...
            <button class="mt-2 bg-[#0B1D51] hover:bg-orange-600 text-white px-4 py-2 rounded text-sm transition">
                Add to Cart
            </button>
        </div>
    @endfor
