...
@section('content')
    ...
    <div
        class="relative w-full h-[400px] bg-white dark:bg-black dark:text-white overflow-hidden flex items-center justify-between px-16">
        ...
        <div class="z-10 max-w-xl text-black space-y-4 transform -translate-y-16 dark:bg-black dark:text-white ">
            ...
            <p>
                ...
                <span class="mx-2 text-gray-500 dark:bg-black dark:text-white"><i
                        class="fa-solid fa-greater-than text-xs font-bold leading-none"></i></span>
