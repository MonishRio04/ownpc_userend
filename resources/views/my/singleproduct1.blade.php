...
<div class="relative w-full h-[400px] bg-cover bg-center flex items-center px-16"
    ...
    <div class="z-10 max-w-xl text-white dark:text-white space-y-4">
        ...
        <p>
            ...
            <span class="font-bold">SINGLE PRODUCT 1</span>
        </p>
    </div>
</div>
        ...
        <div class="lg:w-1/2 bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6">
            ...
            <div class="relative overflow-hidden rounded-xl h-96 mb-4">
                <div class="relative h-full">
                    <div class="carousel-slide absolute inset-0 opacity-100 transition-opacity duration-500" id="slide-1">
                        <img src="{{ asset('images/pc2.jpg') }}" alt="Front View" class="w-full h-full object-cover rounded-xl">
                    </div>
                    <div class="carousel-slide absolute inset-0 opacity-0 transition-opacity duration-500" id="slide-2">
                        <img src="{{ asset('images/keyboard.webp') }}" alt="Interior View" class="w-full h-full object-cover rounded-xl">
                    </div>
                    <div class="carousel-slide absolute inset-0 opacity-0 transition-opacity duration-500" id="slide-3">
                        <img src="{{ asset('images/monitor.avif') }}" alt="Side View" class="w-full h-full object-cover rounded-xl">
                    </div>
                </div>
                ...
                <button class="carousel-prev absolute left-4 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 bg-opacity-70 rounded-full w-10 h-10 flex items-center justify-center">
                    <i class="fas fa-chevron-left text-gray-800 dark:text-white"></i>
                </button>
                <button class="carousel-next absolute right-4 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 bg-opacity-70 rounded-full w-10 h-10 flex items-center justify-center">
                    <i class="fas fa-chevron-right text-gray-800 dark:text-white"></i>
                </button>
            </div>

            <div class="grid grid-cols-3 gap-2 mt-4">
                <img src="{{ asset('images/pc2.jpg') }}" alt="Thumbnail 1" class="w-full h-24 object-cover rounded-xl cursor-pointer">
                <img src="{{ asset('images/keyboard.webp') }}" alt="Thumbnail 2" class="w-full h-24 object-cover rounded-xl cursor-pointer">
                <img src="{{ asset('images/monitor.avif') }}" alt="Thumbnail 3" class="w-full h-24 object-cover rounded-xl cursor-pointer">
            </div>
        </div>
