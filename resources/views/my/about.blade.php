...
@section('content')
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div
            class="max-w-6xl w-full bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div class="px-8 md:px-12 pb-8 md:pb-12">
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-start">
                            ...
                            <span class="text-gray-700 dark:text-gray-300">Expert-built systems for gamers, designers, and
                                developers</span>
                        </div>
                        <div class="flex items-start">
                            <i class="fa-solid fa-square-check text-orange-400 mt-1 mr-3 text-lg"></i>
                            <span class="text-gray-700 dark:text-gray-300">Trusted support and guidance throughout your
                                journey</span>
                        </div>
                        <div class="flex items-start">
                            <i class="fa-solid fa-square-check text-orange-400 mt-1 mr-3 text-lg"></i>
                            <span class="text-gray-700 dark:text-gray-300">Fast delivery and easy upgrade options at your
                                fingertips</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center md:text-left">
                        <a href="{{ route('Appliances') }}"
                            class="inline-block bg-orange-400 text-white font-bold py-3 px-6 rounded-full text-lg shadow-lg hover:bg-[#0B1D51] transition transform hover:-translate-y-1 duration-300">
                            VIEW OUR PRODUCTS
                        </a>
                    </div>
                </div>
    ...
    <div class="relative w-full h-[600px] bg-fixed bg-center bg-cover"
        ...
        <div class="flex flex-col md:flex-row justify-center items-center gap-6 h-full px-10 pt-32 z-10 relative">
            <div
                class="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 h-56 w-full md:w-1/3 flex flex-col justify-between">
