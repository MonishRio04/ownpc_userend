...
@section('content')
    ...
    <div class="max-w-5xl space-y-10 text-gray-800 dark:text-gray-200 text-justify leading-relaxed py-16">
        ...
        <div>
            ...
            <p class="pl-24">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything
                embarrassing</p>
        ...
        <div>
            ...
            <p class="mt-2 pl-24">Latin professor at Hampden-Sydney College in Virginia looked up one of the obscure words
            </p>
        </div>

        <div>
            <h2 class="text-2xl font-bold mb-4 pl-16">Cancellation by Site / Customer</h2>
            <p class="pl-24">Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many
        ...
        <div>
            ...
            <p class="pl-24">There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                alteration</p>
            <p class="mt-2 pl-24">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything
        ...
        <div>
            ...
            <p class="mt-2 pl-24">It uses a dictionary of over 200 Latin words, combined with a handful of model sentence
                structures</p>
        </div>
    </div>
