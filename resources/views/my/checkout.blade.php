...
<div class="max-w-7xl mx-auto p-16 space-y-12 text-black dark:text-white">
        ...
        <tbody>
            <tr>
                ...
                <td class="p-3 border dark:border-gray-700">
                    <input type="number" value="1" min="1" class="w-16 border px-2 py-1 rounded dark:bg-gray-700 dark:text-white">
                </td>
    ...
    <div class="bg-white dark:bg-gray-800 p-6  shadow rounded-xl space-y-6">
        ...
        <div>
            <button class="font-semibold px-6 py-2 border rounded hover:border-orange-400 transition dark:text-white dark:border-gray-500 dark:hover:border-orange-400">
