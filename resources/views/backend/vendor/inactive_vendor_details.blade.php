                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('active.vendor.approve')}}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{(!empty($inactiveVendorDetails->photo)) ?  url('upload/vendor_images/'.$inactiveVendorDetails->photo) : url('upload/no_image.jpg')}}" alt="Admin" style="width: 100px; height:100;">
                                    </div>
                                </div>
                                <div class="row">
