  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Pink Cheeks</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Pink Cheeks Head Office
               Email:support@vakulacollections.com <br>
               Mob: 1245454545 <br>
               Sivakasi 1207,Tamilnadu:#4 <br>
